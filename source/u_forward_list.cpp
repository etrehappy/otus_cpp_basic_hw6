...
{  
    std::cout << "\n 1. Cоздан объект НЕшаблонного класса u_forward_list для хранения элементов типа int в контейнере спискового типа.";
}
...
{    
    ...
    jmp:    ;
    /*std::cout << "\nОбъект f_list удалён деструктором ~u_forward_list()";*/
}
...
//void u_forward_list::test_print_container()
//{
//   Node* it = m_start_node;
//
//    if (it == nullptr)
